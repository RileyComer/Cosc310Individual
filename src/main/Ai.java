...
public class Ai {
  	...
  	private String translate(boolean isInput, String text) {
  		StringBuffer out;
  		...
  		try {
  			URL url=null;
  			if(isInput) {
  				url = new URL("https://www.googleapis.com/language/translate/v2?key=AIzaSyBzVoChrQ-9k7xfqtSti8ZcvlopAQ7phw0&source=de&target=en&q="+URLEncoder.encode(text));
  			}else {
  				url = new URL("https://www.googleapis.com/language/translate/v2?key=AIzaSyBzVoChrQ-9k7xfqtSti8ZcvlopAQ7phw0&source=en&target=de&q="+URLEncoder.encode(text));
  			}
            ...
            map = mapper.readValue(out.toString(), new TypeReference<HashMap<String, Object>>(){});
	...
	public String getResponse(String input) {
         ...
         */
        	input=translate(true,cleanInput(input));
        	out ="";     
